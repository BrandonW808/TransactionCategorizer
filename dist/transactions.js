...
exports.processSharedTransactions = processSharedTransactions;
 ...
 */
function categorizeTransactions(transactions, categories, autoAssignUnknown = true) {
...
function processSharedTransactions(output, shared) {
    const headerRow = output[0];
    const subcategoryIndexMap = {};
